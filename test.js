...
function renderLibrary() {
  ...
  if (!filtersWrap || !itemsWrap) {
    libList.innerHTML = '<style>.no-scroll::-webkit-scrollbar{display:none}
...
</style><div id="lib-filters-container" style="display:flex;gap:8px;overflow-x:auto;padding-bottom:12px;margin-top:-20px;margin-bottom:5px;" class="no-scroll"></div><div id="lib-items-container" style="display:flex;flex-direction:column;gap:15px;"></div>';
